                        ...
                        <div class="widget-content">
                            <div class="shortcuts">
                                <button type="submit" name="showScheduleDoc" value="showScheduleDoc" class="shortcut"
                                        style="height:115px; width:120px" formaction="/web/doctor_main/doctor_doctor_schedule">
                                ...
                                <button type="submit" name="showPatientList" value="showPatientList" class="shortcut"
                                        style="height:115px; width:120px" formaction="/web/doctor_main/doctor_ticket_list">
